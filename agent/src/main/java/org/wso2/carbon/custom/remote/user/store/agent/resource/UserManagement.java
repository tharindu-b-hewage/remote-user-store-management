...
package org.wso2.carbon.custom.remote.user.store.agent.resource;

import org.json.JSONObject;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.wso2.carbon.custom.remote.user.store.agent.constant.CommonConstants;
import org.wso2.carbon.custom.remote.user.store.agent.exception.DatabaseAccessException;
...
import org.wso2.carbon.custom.remote.user.store.agent.manager.common.UserStoreManagerBuilder;
...
public class UserManagement {
    ...
    public Response listUsers() {
        ...
        try {
            ...
            UserStoreManager userStoreManager = UserStoreManagerBuilder.getUserStoreManager(connectionProperties);
