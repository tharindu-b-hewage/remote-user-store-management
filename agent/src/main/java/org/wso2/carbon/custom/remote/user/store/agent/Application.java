...
package org.wso2.carbon.custom.remote.user.store.agent;

import org.wso2.carbon.custom.remote.user.store.agent.exception.DatabaseAccessException;
import org.wso2.carbon.custom.remote.user.store.agent.resource.UserManagement;
...
import static org.wso2.carbon.custom.remote.user.store.agent.constant.CommonConstants.SERVER_PORT;
